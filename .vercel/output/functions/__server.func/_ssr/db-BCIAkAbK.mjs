//#region node_modules/.nitro/vite/services/ssr/assets/db-BCIAkAbK.js
var poolInstance = null;
async function getPool() {
	if (typeof window !== "undefined") throw new Error("Database pool cannot be initialized on the client side.");
	if (!poolInstance) {
...
//#endregion
export { initDb as n, getPool as t };
